...
## Restriccion de diseno para la Fase 16
...
- Hay un `descriptor()` que hoy no usa nadie. Es codigo muerto hasta la Fase 14,
  y es barato.
- La uniformidad de firma obliga a declarar una dataclass de entrada incluso
  para casos de uso que reciben un solo UUID.
- La restriccion sobre SQL libre debe recordarse cuando llegue la Fase 16. Por
